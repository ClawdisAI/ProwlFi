...
All notable changes to the AleaStrategies protocol contracts are documented here.
...
### Changed
- Brand: AleaStrategies → AleaStrategies across the README and contracts.
- Chain: Solana / Anchor program rewritten as Base / Solidity (`contracts/AleaStrategies.sol`).
...
[Unreleased]: https://github.com/alexinbinary/AleaStrategies/compare/v0.1.0...HEAD
[0.1.0]:      https://github.com/alexinbinary/AleaStrategies/releases/tag/v0.1.0
